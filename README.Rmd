...
```{r fig-Tenants-and-Population, echo = FALSE, outwith="1.0\\linewidth", fig.cap="\\label{fig:Tenants-and-Population} the relationship between Tenants  and Population"}
...
```{r fig-Owners-and-Population, echo = FALSE, outwith="1.0\\linewidth", fig.cap="\\label{fig:Owners-and-Population} the relationship between Owners  and Population"}
